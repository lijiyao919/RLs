...
class PPOAgent(object):
    def __init__(self, input_dims, n_actions, eta, gamma, epsilon, batch_size=64, n_epoch=10):
        self.gamma = gamma
    ...
    def learn(self):
        ...
        for _ in range(self.n_epoch):
            for batch in batches:
                states_batch = T.tensor(state_arr[batch], dtype=T.float, device=device)
